...
//         {
//           state === 'Admin'
//             ? <p>Doctor Login? <span className='text-xs underline cursor-pointer text-primary' onClick={() => setState('Doctor')}>Click Here</span></p>
//             : <p>Admin Login? <span className='text-xs underline cursor-pointer text-primary' onClick={() => setState('Admin')}>Click Here</span></p>
//         }
    ...
    try {
      if (state === "Admin") {
        ...
        if (data.success) {
          ...
          // ✅ Redirect doctor (if you have doctor dashboard)
